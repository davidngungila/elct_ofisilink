...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/notifications/mark-shown', [\App\Http\Controllers\NotificationsController::class, 'markShown'])->name('notifications.mark-shown');
    Route::post('/notifications/clear-login-notification', [\App\Http\Controllers\NotificationsController::class, 'clearLoginNotification'])->name('notifications.clear-login-notification');

    // Meeting Management Routes
    Route::prefix('modules/meetings')->name('modules.meetings.')->group(function () {
        // Main pages
        Route::get('/', [MeetingController::class, 'index'])->name('index');
        Route::get('/new', [MeetingController::class, 'create'])->name('create');
        Route::get('/pending-approval', [MeetingController::class, 'pendingApproval'])->name('pending-approval');
        Route::get('/analytics', [MeetingController::class, 'analytics'])->name('analytics');
        Route::get('/categories', [MeetingController::class, 'categories'])->name('categories');
        ...
        Route::get('/{meeting}/minutes', [MeetingController::class, 'minutes'])->name('minutes');
        Route::get('/{meeting}/minutes/create', [MeetingController::class, 'createMinutes'])->name('minutes.create');
...
Route::prefix('api/v1')->name('api.v1.')->group(function () {
    ...
    Route::prefix('admin')->middleware('role:System Admin')->group(function () {
        ...
        Route::get('settings/branches', [SettingsController::class, 'branchSettings'])->name('admin.settings.branches.page');
