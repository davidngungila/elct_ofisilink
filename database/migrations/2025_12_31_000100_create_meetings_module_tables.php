...
return new class extends Migration
{
    ...
    {
        // Tables may already exist from 2024_12_18_create_meetings_tables migration
        if (!Schema::hasTable('meeting_categories')) {
            ...
            Schema::table('meeting_categories', function (Blueprint $table) {
                if (!Schema::hasColumn('meeting_categories', 'is_active')) {
                    $table->boolean('is_active')->default(true)->after('description');
                }
                if (!Schema::hasColumn('meeting_categories', 'updated_by')) {
        ...
        if (!Schema::hasTable('meetings')) {
            ...
            Schema::table('meetings', function (Blueprint $table) {
                if (!Schema::hasColumn('meetings', 'reference_code')) {
                    $table->string('reference_code')->nullable()->unique()->after('title');
                }
        ...
        if (!Schema::hasTable('meeting_minute_items')) {
