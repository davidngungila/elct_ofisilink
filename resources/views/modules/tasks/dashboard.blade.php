...
<div class="container-fluid">
    ...
    <div class="filter-section">
        <form id="filterForm" method="GET" action="{{ route('modules.tasks.index') }}" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    <a href="{{ route('modules.tasks.index') }}" class="btn btn-secondary">
                        <i class="bx bx-x"></i>
                    </a>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#create-task-btn, #create-task-btn-link').on('click', function(e) {
        ...
        window.location.href = '{{ route("modules.tasks.create") }}';
    });
