...
class Meeting extends Model
{
    ...
    public function minutesVisibleUsers(): HasMany
    {
        return $this->hasMany(MeetingMinuteUser::class);
    }

    public function usersWhoCanSeeMinutes(): BelongsToMany
    {
        return $this->belongsToMany(User::class, 'meeting_minute_users', 'meeting_id', 'user_id')
                    ->withTimestamps();
    }
}
