...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Attendance Locations (Reception Areas)
            ['name' => 'attendance_locations.view', 'display_name' => 'View Attendance Locations', 'module' => 'Attendance'],
            ['name' => 'attendance_locations.create', 'display_name' => 'Create Attendance Locations', 'module' => 'Attendance'],
            ['name' => 'attendance_locations.edit', 'display_name' => 'Edit Attendance Locations', 'module' => 'Attendance'],
        ...
        $roles = [
            ...
            [
                ...
                'display_name' => 'General Manager (HQ)',
                'description' => 'Headquarters general manager with full oversight',
                'permissions' => [
                    'dashboard.view',
                    'users.view', 'users.create', 'users.edit',
                    'departments.view', 'departments.create', 'departments.edit',
                    'petty_cash.view', 'petty_cash.create', 'petty_cash.edit', 'petty_cash.approve',
                    'impress.view', 'impress.create', 'impress.edit', 'impress.approve',
                    'gl_accounts.view', 'gl_accounts.create', 'gl_accounts.edit',
                    'journals.view', 'journals.create', 'journals.edit',
            ...
            [
                ...
                'description' => 'Branch-level manager with branch oversight',
                'permissions' => [
                    'dashboard.view',
                    'users.view', 'users.create', 'users.edit',
                    'departments.view',
            ...
            [
                ...
                'description' => 'Reception staff with access to reception areas and incident creation',
                'permissions' => [
                    'dashboard.view',
                    'attendance_locations.view', 'attendance_locations.create', 'attendance_locations.edit',
                    'incidents.view', 'incidents.create',
                    'files.view',
                    'employee.view',
                ]
