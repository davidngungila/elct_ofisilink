...
class TestUsersSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create employee records for all users (required for login)
        $this->createEmployeeRecord($staffUser, 'Staff Member', $itDept);
        $this->createEmployeeRecord($accountantUser, 'Accountant', $financeDept);
        $this->createEmployeeRecord($hodUser, 'Head of Department', $financeDept);
        $this->createEmployeeRecord($ceoUser, 'Chief Executive Officer', $adminDept);
        $this->createEmployeeRecord($hrUser, 'Human Resources Officer', $hrDept);
     ...
     */
    private function createEmployeeRecord(User $user, string $position, ?Department $department): void
    {
        if (!$user->employee) {
            Employee::create([
                'user_id' => $user->id,
