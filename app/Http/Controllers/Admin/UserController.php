...
class UserController extends Controller
{
    ...
    {
        $query = User::with(['roles', 'primaryDepartment', 'branch']);
        ...
        $stats = [
            ...
            'by_role' => DB::table('user_roles')
                ...
                ->get(),
            'by_branch' => User::select('branch_id', DB::raw('count(*) as count'))
        ...
        return view('admin.users.index', compact('users', 'roles', 'departments', 'branches', 'stats'));
    }
