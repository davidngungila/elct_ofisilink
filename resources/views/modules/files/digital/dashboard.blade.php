                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex gap-2 flex-wrap align-items-center">
                            ...
                            <div class="me-3">
                                ...
                                <form method="GET" action="{{ route('modules.files.digital.dashboard') }}" class="d-inline">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.upload') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-primary h-100 text-decoration-none hover-lift">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.manage') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-info h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.search') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-success h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
                        ...
                        @if($canManageFiles)
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.analytics') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-warning h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.access-requests') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-danger h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
                        ...
                        @if($canManageFiles)
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.activity-log') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-secondary h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('modules.files.digital.settings') }}{{ $selectedBranchId ? '?branch_id=' . $selectedBranchId : '' }}" class="card border-dark h-100 text-decoration-none hover-lift">
                                <div class="card-body text-center">
