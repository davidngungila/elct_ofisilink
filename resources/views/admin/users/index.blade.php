        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-label-warning">
                    <h6 class="card-title mb-0 text-white">
                        <i class="bx bx-map me-2"></i>Users by Branch
                    </h6>
                </div>
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        @forelse($stats['by_branch'] ?? [] as $branchStat)
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div>
                                <span class="badge bg-label-warning me-2">{{ $branchStat->branch->name ?? 'Unassigned' }}</span>
                            </div>
                            <strong class="text-warning">{{ $branchStat->count }}</strong>
                        </div>
                        @empty
                        <div class="text-center text-muted py-3">
                            <i class="bx bx-info-circle fs-4 d-block mb-2"></i>
                        ...
                        <table class="table table-hover align-middle" id="usersTable">
                            ...
                            <tbody id="usersTableBody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-label-warning">{{ $user->branch->name ?? 'N/A' }}</span>
                                    </td>
                                    <td>
